...
import { CreateSymptomDto, CreateSymptomResponseDto } from './dto/create-symptom.dto'
...
export class SymptomsController {
    ...
    @Post()
    public async create(@Body() createSymptomDto: CreateSymptomDto): Promise<CreateSymptomResponseDto> {
